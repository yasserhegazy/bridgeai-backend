...
class TestProjectCreation:
    ...
    def test_create_project_duplicate_name_same_team(
        ...
        response = client.post(
            "/api/projects/",
            json={"name": "Unique Project", "description": "Duplicate", "team_id": team_id},
            headers=client_auth_headers
        )
...
class TestProjectRetrieval:
    ...
    def test_get_project_by_id(
        ...
        # Get project
        response = client.get(f"/api/projects/{project_id}", headers=client_auth_headers)
        assert response.status_code == 200
        data = response.json()
    ...
    def test_list_projects_client_sees_approved_and_own(
        ...
        client.post(
            "/api/projects/",
            json={"name": "Approved Project", "description": "By BA", "team_id": team_id},
            headers=ba_auth_headers
        )
        ...
        client.post(
            "/api/projects/",
            json={"name": "Pending Project", "description": "By Client", "team_id": team_id},
            headers=client_auth_headers
        )
    ...
    def test_list_projects_ba_sees_all(
        ...
        pending_project = next((p for p in projects if p["name"] == "Pending Project"), None)
...
class TestProjectUpdate:
    ...
    def test_creator_can_update_own_project(
        ...
        project_response = client.post(
            "/api/projects/",
            json={"name": "Original Name", "description": "Original", "team_id": team_id},
            headers=client_auth_headers
        )
        project_id = project_response.json()["id"]
    ...
    def test_other_user_cannot_update_project(
        ...
        project_response = client.post(
            "/api/projects/",
            json={"name": "Protected Project", "description": "Test", "team_id": team_id},
            headers=client_auth_headers
        )
        project_id = project_response.json()["id"]
...
class TestProjectApprovalWorkflow:
    ...
    def test_ba_approves_pending_project(
        ...
        approval_notif = next((n for n in notifications if "approved" in n.message.lower()), None)
    ...
    def test_ba_rejects_pending_project(
        ...
        project_response = client.post(
            "/api/projects/",
            json={"name": "Project to Reject", "description": "Test", "team_id": team_id},
            headers=client_auth_headers
        )
        project_id = project_response.json()["id"]
        ...
        rejection_notif = next((n for n in notifications if "rejected" in n.message.lower()), None)
    ...
    def test_cannot_approve_already_approved_project(
        ...
        project_response = client.post(
            "/api/projects/",
            json={"name": "Already Approved", "description": "Test", "team_id": team_id},
            headers=ba_auth_headers
        )
        project_id = project_response.json()["id"]
