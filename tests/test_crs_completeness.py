...
class TestFieldQualityValidation:
    ...
    def test_validate_project_description_quality(self):
        ...
        assert filler._validate_field_quality(
            "project_description",
    ...
    def test_validate_functional_requirements_count(self):
        ...
        reqs_good = [
            {"id": "FR-001", "title": "User Authentication", "description": "Implement secure user authentication system with email/password login and password reset functionality", "priority": "high"},
            {"id": "FR-002", "title": "Dashboard", "description": "Create main dashboard view showing real-time project status, task counts, and team member activity metrics", "priority": "high"},
            {"id": "FR-003", "title": "Reports", "description": "Generate PDF and Excel reports with customizable filters for project timeline, budget, and resource allocation", "priority": "medium"},
            {"id": "FR-004", "title": "Notifications", "description": "Send email and in-app notifications for task assignments, deadline reminders, and status updates", "priority": "medium"},
            {"id": "FR-005", "title": "File Upload", "description": "Allow users to upload and attach documents (PDF, Word, Excel) up to 25MB per file with version control", "priority": "low"}
        ]
        assert filler._validate_field_quality("functional_requirements", reqs_good) is True
        
        # Weak (only 3 requirements - less than 5)
        reqs_weak = reqs_good[:3]
        assert filler._validate_field_quality("functional_requirements", reqs_weak) is False
    ...
    def test_validate_objectives_and_users_count(self):
        ...
        assert filler._validate_field_quality(
            "project_objectives",
            ["Improve team productivity and reduce task completion time by 30%", "Reduce operational costs through process automation and resource optimization"]
        ) is True
        ...
        assert filler._validate_field_quality(
            "target_users",
            ["Project managers in software development teams", "Team members and developers working on collaborative projects"]
        ) is True
...
class TestCompletenessCalculation:
    ...
    def test_only_required_fields_sixty_percent(self):
        ...
        template = CRSTemplate(
            ...
            functional_requirements=[
                {"id": "FR-001", "title": "User Authentication", "description": "Implement secure user authentication system with email/password login and password reset functionality", "priority": "high"},
                {"id": "FR-002", "title": "Dashboard", "description": "Create main dashboard view showing real-time project status, task counts, and team member activity metrics", "priority": "high"},
                {"id": "FR-003", "title": "Task Management", "description": "Allow users to create, edit, delete, and assign tasks with priority levels, due dates, and status tracking", "priority": "high"},
                {"id": "FR-004", "title": "Notifications", "description": "Send email and in-app notifications for task assignments, deadline reminders, and status updates", "priority": "medium"},
                {"id": "FR-005", "title": "Reports", "description": "Generate PDF and Excel reports with customizable filters for project timeline, budget, and resource allocation", "priority": "low"}
            ]
        )
    ...
    def test_required_plus_one_optional_eighty_percent(self):
        ...
        template = CRSTemplate(
            ...
            project_objectives=["Improve team productivity and reduce task completion time by 30%", "Streamline project workflows through process automation"]
        )
    ...
    def test_required_plus_two_optional_hundred_percent(self):
        ...
        template = CRSTemplate(
            ...
            project_objectives=["Improve team productivity and reduce task completion time by 30%", "Streamline project workflows through process automation and integration"],
            target_users=["Project managers in software development teams", "Team members and developers working on collaborative projects"]
        )
    ...
    def test_weak_values_dont_count(self):
        ...
        template = CRSTemplate(
            ...
            functional_requirements=[  # Only 1 requirement - WEAK (need 3)
                {"id": "FR-001", "title": "Login", "description": "Auth", "priority": "high"}
            ],
    ...
    def test_more_than_two_optional_capped_at_hundred(self):
        ...
        template = CRSTemplate(
            ...
            success_metrics=["User adoption rate exceeding 80% within 3 months", "Task completion speed improvement of 30% compared to current process"]
        )
    ...
    def test_mixed_quality_fields(self):
        ...
        template = CRSTemplate(
            ...
            functional_requirements=[
                {"id": "FR-001", "title": "Feature One", "description": "Brief description", "priority": "high"},
                {"id": "FR-002", "title": "Feature Two", "description": "Another brief description", "priority": "high"}
...
class TestCompletenessCheck:
    ...
    def test_strict_mode_requires_all_criteria(self):
        ...
        template_incomplete = CRSTemplate(
            ...
            functional_requirements=[
                {"id": "FR-001", "title": "Login", "description": "Auth", "priority": "high"},
                {"id": "FR-002", "title": "Dashboard", "description": "View", "priority": "high"},
                {"id": "FR-003", "title": "Tasks", "description": "Manage", "priority": "high"}
            ]
        )
        
        assert filler._check_completeness(template_incomplete, strict_mode=True) is False
